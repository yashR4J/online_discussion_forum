...
def channels_list_v1(token: Union[str, bytes]) -> list:
    ...
    Return: channel [] - A list containing a dictionary of channels that the user is in
...
def channels_listall_v1(token: Union[str, bytes]) -> list:
...
def channels_create_v1(token: Union[str, bytes], name: str, is_public: bool) -> int:
    '''
