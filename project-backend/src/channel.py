...
def channel_invite_v1(token: Union[str, bytes], channel_id: int, u_id: int) -> dict:
...
def channel_details_v1(token: Union[str, bytes], channel_id: int) -> dict:
...
def channel_messages_v1(token: Union[str, bytes], channel_id: int, start: int) -> dict:
    '''
...
def channel_leave_v1(token: Union[str, bytes], channel_id: int) -> dict:
    '''
...
def channel_join_v1(token: Union[str, bytes], channel_id: int) -> dict:
    '''
...
def channel_addowner_v1(token: Union[str, bytes], channel_id: int, u_id: int) -> dict:
    '''
    ...
    # If User is not a Global Owner, check that they own the channel
    if auth_user_id != 1:
...
def channel_removeowner_v1(token: Union[str, bytes], channel_id: int, u_id: int) -> dict:
    '''
