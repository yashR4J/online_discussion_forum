...
def test_channel_addowner_removeowner_global_owner(setup):
    user3 = auth_register_v1('capoeira@com.au', 'password3', 'Cam', 'Jam')
    assert channel_addowner_v1(setup['sample_user1']['token'], setup['private_channel2'], user3['auth_user_id']) == {}
    assert channel_removeowner_v1(setup['sample_user1']['token'], setup['private_channel2'], user3['auth_user_id']) == {}
