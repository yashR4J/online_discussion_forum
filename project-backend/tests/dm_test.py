...
def test_dm_details_v1(setup):
    # creator access
    member_info = dm_details_v1(setup['sample_user1']['token'], setup['sample_dm1']['dm_id']).get('members')
    member_uids = [member['u_id'] for member in member_info]
    assert member_uids == [setup['sample_user2']['auth_user_id'], setup['sample_user3']['auth_user_id']]

    # member access
    member_info = dm_details_v1(setup['sample_user2']['token'], setup['sample_dm1']['dm_id']).get('members')
    member_uids = [member['u_id'] for member in member_info]
    assert member_uids == [setup['sample_user2']['auth_user_id'], setup['sample_user3']['auth_user_id']]
