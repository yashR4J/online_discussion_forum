...
def test_channel_join(setup):
    ...
    u_id1 = setup['user1']['auth_user_id']
    u1_info = {
        'u_id': u_id1,
        'email': 'apple@com.au',
        'name_first': 'Steve',
        ...
        'profile_img_url': config.url + f'static/{u_id1}.jpg'
    }

    u_id2 = setup['user2']['auth_user_id']
    u2_info = {
        'u_id': u_id2,
        'email': 'banana@com.au',
        'name_first': 'Michael',
        ...
        'profile_img_url': config.url + f'static/{u_id2}.jpg'
    }
